--------------------------------------------------------
--  DDL for Package HRRC21E7
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRRC21E7" is
  ...
  procedure get_skill(json_str_input in clob, json_str_output out clob);
  procedure get_other_talent(json_str_input in clob, json_str_output out clob);
