...
--------------------------------------------------------
  ...
  p_data_each               json_object_t; -- softberry || 28/08/2023 || #9223

  p_addinfo                 json_object_t; --???????????????
  p_doc                     json_object_t; --???????????????????
  p_edu                     json_object_t; --?????????????????????
  p_emppref                 json_object_t; --??????????????????
  p_exp                     json_object_t; --????????????????????????
  p_info                    json_object_t; --????????????????????????
  p_lng                     json_object_t; --?????????????????????
  p_ref                     json_object_t; --????????????
  p_rel                     json_object_t; --?????????????????
  p_spouse                  json_object_t; --?????????????
  p_train                   json_object_t; --????????????????
