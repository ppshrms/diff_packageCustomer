...
--  check secur7
  ...
  procedure insert_temploy3(v_codempid varchar2, v_tapplinf tapplinf%rowtype) as
    ...
    v_flgslip    temploy3.flgslip%type; -- softberry || 31/05/2023 || #9372
...
--<< softberry || 31/05/2023 || #9372
    begin
          select defaultval into  v_flgslip
...
-->> softberry || 31/05/2023 || #9372
    ...
    insert into temploy3
        (
            ...
            flgslip, -- softberry || 31/05/2023 || #9372
    ...
    values
        (
            ...
            v_flgslip, -- softberry || 31/05/2023 || #9372
...
-->> softberry || 10/03/2023 || #8767
  ...
  function replace_html_param(v_param clob,v_codpos varchar2,v_numreq varchar) return varchar2 is
    ...
    cursor c1 is
        select fparam,fvalue,numseq -- softberry || 6/06/2023 || #8739 ||select fparam,fvalue
        from tapplcfmd
        where numappl = p_numappl
