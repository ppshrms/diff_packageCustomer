--------------------------------------------------------
--  DDL for Package HRRC53E
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRRC53E" AS
  ...
  p_dtechg                  thisguarn.dtechg%type;

  -- save detail
  json_params               json_object_t;
  p_warning                 varchar(10 char);--<<#7684
  param_flgwarn             varchar2(100 char) := ''; -- softberry || 20/03/2023 || #8764
