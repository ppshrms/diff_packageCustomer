...
--<< #7195 || USER39 || 19/11/2021
  ...
  begin
    ...
    if v_dtelstpay is not null then -- softberry || 12/06/2023 || #9517
        obj_data.put('dtelstpay', substr(v_dtelstpay,7)||'/'||substr(v_dtelstpay,5,2)||'/'||substr(v_dtelstpay,1,4)); -- softberry || 12/06/2023 || #9517 || obj_data.put('dtelstpay', to_char(v_dtelstpay, 'DD/MM/YYYY'));
--<< softberry || 12/06/2023 || #9517
    else
