--------------------------------------------------------
--  DDL for Package HRRCATE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRRCATE" is
  ...
  param_msg_error		    varchar2(4000 char);
	...
	g_mailalno		        trcalert.mailalno%type;
	g_dteeffec		        varchar2(100 char);

    p_syncond		        trcalert.syncond%type;
	p_table			        varchar2(4000 char);

	p_codtable		        tcoldesc.codtable%type;

	p_date			        varchar2(100 char);
	p_message		        trcalert.message%type;
	p_subject		        trcalert.subject%type;
