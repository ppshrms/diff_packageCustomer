...
--------------------------------------------------------
  ...
  --
  function gen_children(p_codcompp  tcenter.codcomp%type,p_max_dteeffec date,p_complvl torgprt2.numlevel%type) return json_object_t is  -- phisit issue4448#10120 28/11/2023 add p_complvl torgprt2.numlevel%type 
    ...
    cursor c1 is
     ...
     ----and (o1.dteeffec   = b_index_dteeffec or o1.dteeffec2  = b_index_dteeffec2)
         ...
         and (b_index_comgrp is null or (b_index_comgrp is not null and flggroup = 'Y'))
         --<< phisit issue4448#10120 28/11/2023
         and o2.numlevel    <> p_complvl
         -->> 
...
--      obj_data.put('coderror','200');
      ...
      obj_data.put('children',gen_children(i.codcompp,p_max_dteeffec,i.numlevel)); ----add p_max_dteeffec  -- phisit issue4448#10120 28/11/2023 add p_complvl torgprt2.numlevel%type
...
--    obj_row         json_object_t;
    ...
    cursor c1 is
     ...
     ----and (o1.dteeffec   = b_index_dteeffec or o1.dteeffec2  = b_index_dteeffec2)
         and o1.codlinef    = b_index_codlinef
         and o2.numlevel    <= nvl(b_index_comlevel,1)
...
--         and o2.numlevel    <= b_index_comlevel
    ...
    for i in c1 loop
     ...
     obj_data.put('children',gen_children(i.codcompp,v_max_dteeffec,i.numlevel)); ----add v_max_dteeffec  -- phisit issue4448#10120 28/11/2023 add p_complvl torgprt2.numlevel%type
--<< 19/01/2022 #7477
   v_codcompp := i.codcompp;
   obj_assi   := json_object_t();
   v_rcnt_assi :=0;
