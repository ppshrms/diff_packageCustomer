  ...
  begin
    ...
    for i in 0..param_json.get_size-1 loop
      ...
      if v_flg = 'add' then
        ...
        --<< softberry || 9/11/2023 || #10126 
        param_msg_error := get_error_msg_php('HR2005',global_v_lang, v_codpos||' - '||get_tpostn_name(v_codpos, global_v_lang)); -- softberry || 21/11/2023 || #10126 || param_msg_error := get_error_msg_php('HR2005',global_v_lang,'tgrppos');
        begin
          select codpos
            into v_codpos
            from tgrppos
        ...
        -->> softberry || 23/11/2023 || #10126   
        if param_msg_error is null then -- softberry || 9/11/2023 || #10126
            begin
