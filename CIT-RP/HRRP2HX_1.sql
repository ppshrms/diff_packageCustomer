...
--#7124 || User39 || 28/10/2021
    ...
    global_v_codempid   := hcm_util.get_string_t(json_obj,'p_codempid'); -- softberry || 18/09/2023 || #9435
  end initial_value;
  --
...
--<< softberry || 18/09/2023 || #9435
    v_seq                 number := 1;
    graph_x_desc        varchar2(200 char);
    graph_x_desc_p          varchar2(200 char);
    graph_x_desc_b          varchar2(200 char);
...
--<< softberry || 18/09/2023 || #9435
    begin
      delete
        from ttemprpt
       where codapp = 'HRRP2HX'
         and codempid = global_v_codempid;
    end;
    graph_y_desc := get_label_name('HRRP2HX',global_v_lang,80);
    graph_x_desc_p := get_label_name('HRRP2HX',global_v_lang,120);
    graph_x_desc_b := get_label_name('HRRP2HX',global_v_lang,130);
    graph_x_desc := get_label_name('HRRP2HX',global_v_lang,50);
-->> softberry || 18/09/2023 || #9435
...
--<< softberry || 18/09/2023 || #9435
          ...
          VALUES (global_v_codempid, 'HRRP2HX', v_seq,
          '',
          '',
          '',
          get_tpostn_name(i.codpos,global_v_lang),
          get_tpostn_name(i.codpos,global_v_lang),graph_y_desc,
          v_present, graph_x_desc_p,
          ...
          get_tpostn_name(i.codpos,global_v_lang),
          get_tpostn_name(i.codpos,global_v_lang),graph_y_desc,
          i.qtybudgt - v_present + v_procur - v_moveout1 - v_moveout2, graph_x_desc_b,
          get_label_name('HRAP3WE2',global_v_lang,10),
          '',null,graph_x_desc);
          v_seq := v_seq + 1;
-->> softberry || 18/09/2023 || #9435
