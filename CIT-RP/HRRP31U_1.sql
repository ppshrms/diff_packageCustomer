...
--    end if;
  ...
  procedure process_approve(json_str_input in clob, json_str_output out clob) as
    ...
    v_error_message  VARCHAR(6000 char);
  begin
    initial_value(json_str_input);
    check_approve;
    ...
    if v_staappr = 'N' then
      ...
      v_error := '2402';
        ...
        if p_check = 'N' then
            ...
            begin
                v_error := chk_flowmail.send_mail_for_approve('HRRP68E', v_codempid, global_v_codempid, global_v_coduser, null, 'HRRP68E1', 130, 'U', v_staappr, v_approvno, null, null,'TTALENTE',v_rowid, '1', null);
            EXCEPTION WHEN OTHERS THEN
                v_error := '2403';
            END;
    ...
    if param_msg_error is not null then
      ...
      rollback;
      return;
    elsIF v_error in ('2046','2402') OR v_error is null THEN
