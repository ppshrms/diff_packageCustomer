    ...
    cursor c_com_pos is
      select a.numpath, decode(global_v_lang,'101',a.despathe,
       ...
       where a.codcompy = b.codcompy
         ...
         and b.numseq >= (select max(d.numseq) -- softberry || 3/10/2023 || #9364 || and b.numseq >= (select d.numseq
                                from tposplnd d
...
--                obj_data.put('agepos',r1.agepos);
                v_agepos := floor(r1.agepos/12)||'('||mod(r1.agepos,12)||')'; -- softberry || 5/10/2023 || #9365 || v_agepos := round(r1.agepos/12)||'('||mod(r1.agepos,12)||')';
