...
--------------------------------------------------------
  ...
  --
  function gen_children(p_codcompp  tcenter.codcomp%type, p_complvl torgprt2.numlevel%type) return json_object_t is
    obj_data        json_object_t;
    obj_row         json_object_t;
...
--         and o2.numlevel    <= b_index_comlevel
         ...
         --<< redmine 4448#10207 fix by kowit
...
--      obj_data.put('orgid',trunc(DBMS_RANDOM.VALUE(1000000000000,9999999999999)));
      ...
      obj_data.put('children',gen_children(i.codcompp, i.numlevel));
