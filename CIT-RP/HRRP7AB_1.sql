--------------------------------------------------------
--  DDL for Package Body HRRP7AB
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HRRP7AB" AS
  ...
  function check_submit return varchar2 is
    ...
    v_remark    	    varchar2(5000 char);--User37 #4460 14/09/2021 tappemp.remark%type;
    v_flgsecu			boolean;
