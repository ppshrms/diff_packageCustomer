...
-- last update: 07/08/2020 09:40
  ...
  begin
    ...
    for i in c1 loop
      ...
      /*Type1 QTY employees*/
      v_idx := v_idx + 1;
      insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31,item7) -- softberry || 28/09/2023 || #9370 || insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31)
      values (global_v_codempid, 'HRRPSBX',v_idx,
              ...
              i.count_m,get_label_name('HRRPSBX2',global_v_lang,10),1); -- softberry || 28/09/2023 || #9370 || i.count_m,get_label_name('HRRPSBX2',global_v_lang,10));
      v_idx := v_idx + 1;
      insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31,item7) -- softberry || 28/09/2023 || #9370 || insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31)
      values (global_v_codempid, 'HRRPSBX',v_idx,
              get_label_name('HRRPSBX2',global_v_lang,20), v_codcomp, get_tcenter_name(v_codcomp,global_v_lang),
              get_label_name('HRRPSBX2',global_v_lang,40),get_label_name('HRRPSBX2',global_v_lang,20),
              i.count_f,get_label_name('HRRPSBX2',global_v_lang,10),2); -- softberry || 28/09/2023 || #9370 || i.count_f,get_label_name('HRRPSBX2',global_v_lang,10));
      v_idx := v_idx + 1;
      insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31,item7) -- softberry || 28/09/2023 || #9370 || insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31)
      values (global_v_codempid, 'HRRPSBX',v_idx,
              get_label_name('HRRPSBX2',global_v_lang,20), v_codcomp, get_tcenter_name(v_codcomp,global_v_lang),
              get_label_name('HRRPSBX2',global_v_lang,50),get_label_name('HRRPSBX2',global_v_lang,20),
              i.count_all,get_label_name('HRRPSBX2',global_v_lang,10),3); -- softberry || 28/09/2023 || #9370 || i.count_all,get_label_name('HRRPSBX2',global_v_lang,10));
      ...
      values (global_v_codempid, 'HRRPSBX',v_idx,
              ...
              round(i.min_qtywork/12,1),get_label_name('HRRPSBX2',global_v_lang,10),1); -- softberry || 28/09/2023 || #9370 || round(i.min_qtywork/12,1),get_label_name('HRRPSBX2',global_v_lang,10));
      v_idx := v_idx + 1;
      insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31,item7) -- softberry || 28/09/2023 || #9370 ||insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31)
      values (global_v_codempid, 'HRRPSBX',v_idx,
              get_label_name('HRRPSBX2',global_v_lang,60), v_codcomp, get_tcenter_name(v_codcomp,global_v_lang),
              get_label_name('HRRPSBX2',global_v_lang,80),get_label_name('HRRPSBX2',global_v_lang,60),
              round(i.max_qtywork/12,1),get_label_name('HRRPSBX2',global_v_lang,10),2); -- softberry || 28/09/2023 || #9370 || round(i.max_qtywork/12,1),get_label_name('HRRPSBX2',global_v_lang,10));
      v_idx := v_idx + 1;
      insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31,item7) -- softberry || 28/09/2023 || #9370 ||insert into ttemprpt (codempid,codapp,numseq,item1, item4,item5, item8,item9, item10,item31)
      values (global_v_codempid, 'HRRPSBX',v_idx,
              get_label_name('HRRPSBX2',global_v_lang,60), v_codcomp, get_tcenter_name(v_codcomp,global_v_lang),
              get_label_name('HRRPSBX2',global_v_lang,90),get_label_name('HRRPSBX2',global_v_lang,60),
              round(i.avg_qtywork/12,1),get_label_name('HRRPSBX2',global_v_lang,10),3); -- softberry || 28/09/2023 || #9370 || round(i.avg_qtywork/12,1),get_label_name('HRRPSBX2',global_v_lang,10));
    end loop;
