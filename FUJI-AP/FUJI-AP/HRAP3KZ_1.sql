--------------------------------------------------------
--  DDL for Package Body HRAP3KZ
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HRAP3KZ" is
  ...
  procedure gen_index(json_str_output out clob) is
    ...
    cursor c1 is
      select b.codcalen ,a.codempid
        ...
        and a.flgtrnpy   = 'Y'
        group by b.codcalen ,a.codempid
    ...
    for i in c1 loop
        ...
        if v_secur then
          ...
          */
             ...
             obj_data.put('image8899'          , get_emp_img(i.codempid));                              -- col.1
             obj_data.put('codempid'       , i.codempid);                        -- col.2

--             obj_data.put('namemp'         , get_temploy_name(i.codempid,global_v_lang));           -- col.3
--             obj_data.put('jobgrade'       , get_tcodec_name('TCODJOBG',v_jobgrade,global_v_lang)); -- col.4
