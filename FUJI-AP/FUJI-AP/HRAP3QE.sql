--------------------------------------------------------
--  DDL for Package HRAP3QE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRAP3QE" as
  --para
  ...
  b_index_sumwgt        tkpidph.wgt%type;       -- << Apisit || 04/08/2023 || issue #9849
  ...
  procedure get_res_emp(json_str_input in clob,json_str_output out clob);
