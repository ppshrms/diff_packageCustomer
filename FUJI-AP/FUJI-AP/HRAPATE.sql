--------------------------------------------------------
--  DDL for Package HRAPATE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRAPATE" is
  ...
  param_msg_error		    varchar2(4000 char);
	...
	g_mailalno		        tapalert.mailalno%type;
	g_dteeffec		        varchar2(100 char);

    p_syncond		        tapalert.syncond%type;
	p_table			        varchar2(4000 char);

	p_codtable		        tcoldesc.codtable%type;

	p_date			        varchar2(100 char);
	p_message		        tapalert.message%type;
	p_subject		        tapalert.subject%type;
