...
--      end if;
  ...
  procedure gen_index_table1 (json_str_output out clob) as
    ...
    v_stacard       varchar2(1000 char);
    v_flgdata       varchar2(1 char) := 'N';
    v_flgdefault     varchar2(1 char) := 'N';
    t_tbonparh      tbonparh%rowtype;
  ...
  begin
      ...
      obj_data.put('bonus', to_char(nvl(v_amtbon,0),'fm999,999,999,990.00'));
      obj_data.put('salary', to_char(nvl(v_qtybon,0),'fm999,999,999,990.00'));
