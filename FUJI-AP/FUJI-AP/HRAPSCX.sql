--------------------------------------------------------
--  DDL for Package HRAPSCX
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRAPSCX" is
-- last update: 08/09/2020 10:30
  ...
  procedure gen_graph;
  function get_compbudg(p_codcomp in varchar2,p_dteyreap in number) return varchar2; ----
END; -- Package spec
