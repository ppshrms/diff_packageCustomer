...
--    order by codempid;
    -- BK >
    cursor c1 is
      select codempid,codcomp,codpos,qtywork,amtsal,qtyscore,grade,pctadjsal,pctcalsal,amtadj,amtbudg,amtsaln,dteyreap
        from tapprais
       where dteyreap   = b_index_year
         and codcomp    like b_index_codcomp||'%'
    order by codempid;
  ...
  begin
    ...
    for r1 in c1 loop
      ...
      if v_secur then
        ...
        obj_data.put('dteyreap', to_char(r1.dteyreap)); -- < apisit || 26/7/2566 || #9787
