...
-- last update: 02/09/2020 10:17
  ...
  procedure gen_data(json_str_output out clob) is
    ...
    TYPE arr_dteyear IS VARRAY(3) OF VARCHAR2(200);
    v_arr_dteyear arr_dteyear := arr_dteyear(b_index_dteyear1, b_index_dteyear2, b_index_dteyear3);
...
--              for k in 1..v_seq_yre loop
              FOR k IN 1 .. v_arr_dteyear.COUNT LOOP
                v_cs := v_cs+1;
                if  v_cs = v_cs1 then
                         begin
