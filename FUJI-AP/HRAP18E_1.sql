...
-- Comment: 4449#2264 add condition check already assess cant delete/edit
  ...
  procedure gen_index(json_str_output out clob) is
    ...
    v_count_tappfm  number := 0; -- softberry || 11/07/2023 || #9449
    v_flg_can_edit  boolean := true; -- softberry || 21/08/2023 || #9449

    v_count_tappemp number := 0; -- 000554-bow.sarunya-dev | 4449#2264: add check tappemp | 01/08/2024
    ...
    cursor c2 is
      select codcomp, numtime, flgtypap, dteapstr, dteapend, dtebhstr, dtebhend, dteaplast, qtyalert1, qtyalert2, flgsal
             ,codaplvl -- softberry || 11/07/2023 || #9449
        from tstdisd
  ...
  begin
    ...
    for i in c1 loop
      ...
      obj_data.put('can_edit', v_flg_can_edit); -- softberry || 21/08/2023 || #9449
