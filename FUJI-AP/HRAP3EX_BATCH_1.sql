--------------------------------------------------------
--  DDL for Package Body HRAP3EX_BATCH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HRAP3EX_BATCH" as
        ...
        for i in c_tappemp loop
            ...
            if v_flgsecu then
                ...
                if v_flgfound <> 0 then
                    ...
                    --% increase
                    v_pctincrease := (((nvl(i.qtyadjtot,i.qtytotnet) - r_tstdis.pctwkstr)/(r_tstdis.pctwkend - r_tstdis.pctwkstr )) * ((r_tstdis.pctpoend  - r_tstdis.pctpostr))) + 
                                        (r_tstdis.pctpostr * nvl(i.qtyadjtot,i.qtytotnet)) ;
