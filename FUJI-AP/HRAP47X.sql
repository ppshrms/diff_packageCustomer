--------------------------------------------------------
--  DDL for Package HRAP47X
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "HRAP47X" is
  -- last update: 26/08/2020 16:50
      ...
      b_index_target          varchar2(4000 char);
      b_index_pctwgt          number;
    ...
    procedure get_data3(json_str_input in clob, json_str_output out clob);
